...
if target == 'Rec709':
    ...
    newLines = [x.replace('replaceForward_Rec709.cub',os.path.basename(cubPath)) for x in lines]
    newLines = [x.replace('replaceForward_Rec2100.cub',os.path.basename(cubPath).replace('Rec709','Rec2100')) for x in lines]
